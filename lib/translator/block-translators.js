...
function translateFrom(scope, block) {
    ...
    let translatedInit =translateBlock(subscope, block.init);
    let translatedTest = translateBlock(subscope, testBlock);
    let translatedUpdate = translateBlock(subscope, updateBlock);
