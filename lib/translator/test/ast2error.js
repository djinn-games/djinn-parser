...
describe('Translator AST errors', function () {
    beforeEach(function () {
    ...
    it('indicates line number when throwing errors', function () {
        expect(function () {
            this.translator.toEstree({ type: "WakaWaka", line: 1337 });
        }.bind(this)).to.throw(/Line 1337/i);
    });
});
