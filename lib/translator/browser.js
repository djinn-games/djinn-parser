...
Translator.prototype._translateVarDeclaration = function (scope, block) {
    ...
    let init = block.init
        ...
        : this._defaultLiteralForType(block.dataType, block.line);

    // assert data type of initialization, unless it was one by default
    if (block.init) { this._assertDataType(init, [block.dataType]); }
...
Translator.prototype._defaultLiteralForType = function (dataType, line) {
    let res = { type: 'Literal', line: line };
