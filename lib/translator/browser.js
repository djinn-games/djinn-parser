...
Translator.prototype._translateUnaryOperation = function (scope, block) {
    this.assertDataType(block.right, block.operator === 'not'
        ? ['bool']
        : ['int', 'float']);
...
Translator.prototype._translateBinaryOperation = function (scope, block) {
    ...
    this.assertBinaryOperands(block);
...
Translator.prototype._translateIdentifier = function (scope, block, isFunction) {
    this.assertIdentifierExists(scope, block, isFunction);
...
Translator.prototype._translateVarDeclaration = function (scope, block) {
    ...
    if (block.init) { this.assertDataType(block.init, [block.dataType]); }
...
Translator.prototype._translateAssignment = function (scope, block) {
    ...
    this.assertIdentifierExists(scope, block.left);
    ...
    this.assertDataType(block.right, [lookup.dataType]);
...
_.extend(Translator.prototype, require('./asserters.js'));
